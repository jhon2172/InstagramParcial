...
const FooterMobile = () => {
    // estilos del Footer version telefono
    const _styleFooterMobile={
        container:{
        ...
        // Retorna Iconos
    return(
        <div style={{..._styleFooterMobile.container}}>
           <svg  aria-label="Inicio" className="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
            ...
            <svg aria-label="Buscar y explorar" class="_8-yf5 " color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48" width="20">
            ...
            <svg aria-label="Nueva publicación" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24">
            ...
            <svg aria-label="Actividad" class="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24">
